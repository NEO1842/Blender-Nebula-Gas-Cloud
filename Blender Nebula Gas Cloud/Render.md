...
To match the animation length from the preview video, duplicate the rendered sequence approximately 7 times, then connect them together.
...
動画の長さを揃えるには、レンダリングしたシーケンスを約7回複製して連結してください。
...
![Preview](Nebula%20Gas%20Cloud.png)
